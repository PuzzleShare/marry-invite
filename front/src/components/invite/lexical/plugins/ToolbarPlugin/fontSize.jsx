...
import { calculateNextFontSize } from "./utils";
  ...
  return (
    <>
      <button
        ...
        onClick={() => {
          setInputValue(
            calculateNextFontSize(inputValue, UpdateFontSizeType.decrement)
          );
      ...
      <button
        ...
        onClick={() => {
          setInputValue(
            calculateNextFontSize(inputValue, UpdateFontSizeType.increment)
          );
